    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagle', models.CharField(default='', max_length=100, verbose_name='Слоган')),
                ('description', models.TextField(verbose_name='Описание')),
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='Указывает сумму в долларах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='Указвать сумму в долларах', verbose_name='Сборы в США')),
                ('fess_in_world', models.PositiveIntegerField(default=0, help_text='Указывать сумму в долларах', verbose_name='Сборы в США')),
                ('url', models.SlugField(max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip_adres', models.CharField(max_length=15, verbose_name='IP адрес')),
                ('movi', models.ForeignKey(on_delete=django.db.models.fields.CharField, to='movies.movie', verbose_name='Фильмы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описание')),
                ('image', models.ImageField(upload_to='movie_shots/', verbose_name='Изображенмие')),
